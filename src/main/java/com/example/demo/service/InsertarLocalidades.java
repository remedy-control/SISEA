...
@Service
public class InsertarLocalidades {

    @Value("${demo.service.url}")
    private String ip;

    public String InsertarLocalidades(Usuario usuario) throws IOException {
        ...
        return "Se ha realizado el consumo";
    }

    public String InsertLocalid_api(Usuario usuario) throws IOException {
